...
var routes = [{ path: '', redirectTo: 'list', pathMatch: 'full' },
...
var ProductDetailComponent = /** @class */ (function () {
    function ProductDetailComponent(router, route, service) {
        var _this = this;
        this.router = router;
        this.route = route;
    ...
    ProductDetailComponent.prototype.ngOnInit = function () {
        ...
        this.product = this.service.getProduct(this.routeParamId).subscribe(function (succ) {
            _this.product = succ;
            _this.productLoaded = true;
            console.log(succ);
        }, function (err) {
            _this.producErrored = true;
            console.log(err);
        });
    };
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(router) {
        var _this = this;
        this.router = router;
        this.navigateToDetailsPage = function (id) { return _this.router.navigate(["/products/" + id]); };
    }
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(service, modalService) {
        var _this = this;
        this.service = service;
        this.modalService = modalService;
        this.products = [];
        this.errorMessage = "";
        this.submitForm = function (form, content) {
            console.log(form.value);
            _this.service.postProduct(form.value).subscribe(function (succ) {
                _this.products.push(succ);
                console.log(succ);
                content.dismiss();
            }, function (err) {
    ...
    ProductsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getProducts().subscribe(function (succ) {
            console.log(succ);
            _this.products = succ;
...
var ProdcutService = /** @class */ (function () {
    function ProdcutService(http) {
        var _this = this;
        this.http = http;
        this.prodBaseUrl = "https://johnnyproducts.azurewebsites.net/api/products";
        this.baseUrl = "https://localhost:44325/api/products";
        this.getProducts = function () { return _this.http.get(_this.baseUrl); };
        this.getProduct = function (id) { return _this.http.get(_this.baseUrl + "/" + id); };
        this.postProduct = function (newProduct) { return _this.http.post(_this.baseUrl, newProduct); };
    }
    ProdcutService.ctorParameters = function () { return [
